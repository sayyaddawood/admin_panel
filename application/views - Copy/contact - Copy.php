  ...
  <div class="main-content bg-lighter">
    ...
    <section class="divider layer-overlay  overlay-white-1" data-bg-img="images/bg/bg15.jpg">
      <div class="container">
	    ...
	    <h3 class="text-black">	      
	      <p style="text-align: center; height: 65px; color: black;" class="statusMsg"><?php echo $statusMsg; ?></p>
	    <?php } ?>
	    </h3>
          <div class="col-md-8">
            <h3 class="line-bottom mt-0 mb-20">If Interested Write Us</h3>
            <!-- Contact Form -->
            <form id="contact_form" name="contact_form" <?php echo base_url("Contact/SubmitContactUsForm"); ?> action="contactus.php" method="post">
              <div class="row">
                <div class="col-sm-6">
