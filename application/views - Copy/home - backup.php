...
<div id="wrapper" class="clearfix">
        ...
        <div class="container">
          <nav id="menuzord-right" class="menuzord default">
            <a class="menuzord-brand pull-left flip" href="javascript:void(0)">
              <img src="<?php echo base_url()?>appassets/images/logo-wide.png" alt="">
            </a>
  ...
  <div class="main-content">
    ...
    <section id="home">
      ...
      <div class="rev_slider_wrapper">
        <div class="rev_slider" data-version="5.0">
          <ul>
            ...
            <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="http://placehold.it/1920x1280" data-rotate="0" data-saveperformance="off" data-title="Slide 1" data-description="">
              <!-- MAIN IMAGE -->
              <img src="<?php echo base_url().'assets/images/slider/supply_chain.jpg'; ?>" alt="" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
              <!-- LAYERS -->
              ...
              <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway"
                ...
                style="z-index: 7; white-space: nowrap; font-weight:700;">Standardized
              </div>
              ...
              <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway bg-theme-colored-transparent border-left-theme-color-2-6px pl-20 pr-20"
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 7; white-space: nowrap; font-weight:600;">Supply Chain Management 
              </div>
		...
		Understanding the importance of SCM to business, Elite Enterprises has transformed its <br>
		supply chain by investing in technology to streamline the entire process. Our main purpose <br> 
		is to maximize customer value and gain a competitive advantage in the marketplace.
              </div>
            ...
            <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="http://placehold.it/1920x1280" data-rotate="0" data-saveperformance="off" data-title="Slide 2" data-description="">
              <!-- MAIN IMAGE -->
              <img src="<?php echo base_url().'assets/images/slider/distribution.jpg'; ?>"  alt=""  data-bgposition="center 40%" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
              <!-- LAYERS -->
              ...
              <div class="tp-caption tp-resizeme text-uppercase  bg-theme-colored-transparent text-white font-raleway border-left-theme-color-2-6px border-right-theme-color-2-6px pl-30 pr-30"
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 7; white-space: nowrap; font-weight:400; border-radius: 30px;  margin-top: 220px;">National Distributor
              </div>
              ...
              <div class="tp-caption tp-resizeme text-uppercase bg-theme-colored-transparent text-white font-raleway pl-30 pr-30"
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 7; white-space: nowrap; font-weight:700; border-radius: 30px;  margin-top: 220px;">Quality Distribution System
              </div>
              ...
              <div class="tp-caption tp-resizeme text-white text-center" 
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 5; white-space: nowrap; letter-spacing:0px; font-weight:400; margin-top: 220px;">
		  Elite Enterprises is a specializing in Distribution of Medicine, <br>
		  Import & Sale of Medical Equipment and devices, furniture & other Hospital related items, <br> Provision of Government contracting & General Order Supplies.
              </div>
            ...
            <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="http://placehold.it/1920x1280" data-rotate="0" data-saveperformance="off" data-title="Slide 3" data-description="">
              <!-- MAIN IMAGE -->
              <img src="<?php echo base_url().'assets/images/slider/quality_assurance.jpg'; ?>"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
              <!-- LAYERS -->
              ...
              <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway bg-theme-colored-transparent border-right-theme-color-2-6px pr-20 pl-20"
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 7; white-space: nowrap; font-weight:600;">Quality Assurance
              </div>
              ...
              <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway"
                ...
                data-splitout="none" 
                data-responsive_offset="on"
                style="z-index: 7; white-space: nowrap; font-weight:600;">Quality Management System
              </div>
		  ...
		  Elite Enterprises have developed and implemented a Quality Management System. <br> We never compromise quality for price.
              </div>
            ...
            <div class="owl-carousel-3col owl-nav-top" data-dots="true">
              <div class="item">
                <div class="project mb-30 border-2px">
                  <div class="thumb">
                    <img class="img-fullwidth" alt="" src="http://placehold.it/370x285">
    ...
    <section id="mission">
      <div class="container-fluid pt-0 pb-0">
        <div class="row equal-height">
          ...
          <div class="col-sm-6 col-md-6 p-0 bg-img-cover wow fadeInRight hidden-xs" data-bg-img="http://placehold.it/800x455" data-wow-duration="1s" data-wow-delay="0.3s">
          </div>
        </div>
      </div>
    </section>
            ...
            <div class="owl-carousel-4col" data-nav="true">
              <div class="item">
                <div class="hover-effect mb-30">
                  <div class="thumb">
                    <img class="img-fullwidth" alt="" src="http://placehold.it/260x300">
                    <div class="hover-link">
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="<?php echo base_url()?>appassets/images/gallery/6.jpg"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="<?php echo base_url()?>appassets/images/gallery/7.jpg"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="<?php echo base_url()?>appassets/images/gallery/8.jpg"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="<?php echo base_url()?>appassets/images/gallery/9.jpg"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    <!-- Section: Claints Say -->
    <section class="divider parallax layer-overlay overlay-theme-color-sky" data-bg-img="http://placehold.it/1920x1280">
            ...
            <div class="owl-carousel-3col  style2 dots-white" data-dots="false">
              <div class="item">
                <div class="testimonial bg-theme-color-2 p-30 pb-20 mt-50">
                  ...
                  <div class="thumb content mt-30"><img class="img-circle" alt="" src="http://placehold.it/70x70"></div>
    ...
    <!-- Section: Blog -->
    <section id="blog" class="divider parallax layer-overlay overlay-dark-8" data-stellar-background-ratio="0.5" data-bg-img="http://placehold.it/1920x1280">
              ...
              <article class="post clearfix mb-sm-30">
                <div class="entry-header">
                  <div class="post-thumb thumb"> 
                    <img src="http://placehold.it/370x247" alt="" class="img-responsive img-fullwidth"> 
                  </div>
                </div>
  ...
  <!-- Footer -->
  <footer id="footer" class="footer bg-black-222" data-bg-img="<?php echo base_url()?>appassets/images/footer-bg.png">
    <div class="container pt-70 pb-40">
      <div class="row">
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            <img class="mt-10 mb-15" alt="" src="<?php echo base_url()?>appassets/images/logo-wide-white.png">
