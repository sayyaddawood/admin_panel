<header class="topbar" data-navbarbg="skin5">
          ...
          <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand" href="<?php echo base_url(); ?>Members">
              ...
              <b class="logo-icon ps-2">
                ...
                <!-- Dark Logo icon -->
                <img
                  src="<?php echo base_url()?>appassets//assets/images/logo-icon.png"
                  alt="homepage"
                  class="light-logo"
                  width="25"
                />
		...
		<h3>PTI Members</h3>
                <!--<img
                  src="<?php // echo base_url()?>appassets//assets/images/logo-text.png"
                  alt="homepage"
                  class="light-logo"
                />-->
              </span>
          ...
          >
            ...
            <ul class="navbar-nav float-end">
              ...
              <li class="nav-item dropdown">
                ...
                >
                  <img
                    src="<?php echo base_url()?>appassets//assets/images/users/1.jpg"
                    alt="user"
